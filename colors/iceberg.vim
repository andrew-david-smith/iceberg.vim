...
hi Normal ctermbg=234 ctermfg=252 guibg=bg guifg=#c6c8d1
...
hi Conceal ctermbg=234 ctermfg=242 guibg=bg guifg=#6b7089
hi Constant ctermfg=140 guifg=#a093c7
hi Cursor ctermbg=252 ctermfg=234 guibg=#c6c8d1 guifg=bg
...
hi Error ctermbg=234 ctermfg=203 guibg=bg guifg=#e27878
hi ErrorMsg ctermbg=234 ctermfg=203 guibg=bg guifg=#e27878
hi WarningMsg ctermbg=234 ctermfg=203 guibg=bg guifg=#e27878
...
hi TabLineSel cterm=NONE ctermbg=234 ctermfg=252 gui=NONE guibg=bg guifg=#9a9ca5
hi TermCursorNC ctermbg=242 ctermfg=234 guibg=#6b7089 guifg=bg
...
hi Sneak ctermbg=140 ctermfg=234 guibg=#a093c7 guifg=bg
